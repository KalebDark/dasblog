...
namespace DasBlog.Import {
	...
	public class EntryPoint {
		...
		/// </summary>
		/// <param name="commandLine_">The commandline that invoked the program.  Usually
		/// this corresponds to System.Environment.CommandLine</param>
		/// <returns></returns>
		public static void DllMain(string commandLine_) {
			CommandLine = new CommandLine();
			Parser parser = new Parser(commandLine_, CommandLine);
			parser.Parse();
